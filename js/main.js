let app = new Vue({
    ...
    data: {
        ...
        score: { //Количество очков для каждой расы
            'zerg': 0,
            'primal': 0,
            'protoss': 0,
            'taldarim': 0,
        ...
        totalGame: localStorage.getItem('sc2TotalGame') ? JSON.parse(localStorage.getItem('sc2TotalGame')) : { //Количество очков для каждой расы после партий
            'zerg': 0,
            'primal': 0,
            'protoss': 0,
            'taldarim': 0,
        ...
        totalGames: localStorage.getItem('sc2TotalGames') ? localStorage.getItem('sc2TotalGames') : 0, //Общее количество сыгранных партий
        questions: questions,
        results: results,
        resultRace: 'infested', //Результирующая раса
    },
    methods: {
        goToMain() {
            this.showMain = true
        ...
        nextQuestions(answer) {
            ...
            eval(answer) //Функция, позволяющая выполнить строчку кода
        },
        endGame() {
            this.totalGames++
